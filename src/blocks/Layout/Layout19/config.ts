...
export const Layout19: Block = {
  slug: 'layout19',
  interfaceName: 'Layout19Block',
  labels: {
    singular: 'Layout 19 - Text links, Bild rechts, Features',
    plural: 'Layout 19 - Text links, Bild rechts, Features',
  },
  fields: [
    ...
    // * Features Array
    {
      ...
      label: 'Features',
      admin: {
        description: 'Fügen Sie Merkmale/Features als Listenpunkte hinzu',
      },
      minRows: 1,
      fields: [
        {
          ...
          label: 'Feature Text',
          admin: {
            description: 'Text für den Listenpunkt',
          },
          required: true,
        },
      ],
