...
export const Layout239: Block = {
  slug: 'layout239',
  interfaceName: 'Layout239Block',
  labels: {
    singular: 'Layout 239 - Centered Sections mit Cards',
    plural: 'Layout 239 - Centered Sections mit Cards',
  },
  fields: [
    ...
    // * Sections Array
    {
      ...
      label: 'Sections',
      admin: {
        description: 'Fügen Sie Sections mit Bild, Überschrift und Beschreibung hinzu',
      },
      minRows: 1,
      fields: [
        {
          ...
          label: 'Bild',
          admin: {
            description: 'Bild für die Section. Empfohlen: Querformat, mindestens 600x400px',
          },
          required: true,
        },
        {
          ...
          label: 'Heading',
          admin: {
            description: 'Überschrift für die Section',
          },
          required: true,
        },
        {
          ...
          label: 'Beschreibung',
          admin: {
            description: 'Beschreibung der Section',
          },
          required: true,
        },
      ],
