...
export const Layout16: Block = {
  slug: 'layout16',
  interfaceName: 'Layout16Block',
  labels: {
    singular: 'Layout 16 - Features mit Bild und Icons',
    plural: 'Layout 16 - Features mit Bild und Icons',
  },
  fields: [
    ...
    // * Features Array
    {
      ...
      label: 'Features',
      admin: {
        description: 'Fügen Sie Features mit Icon und Beschreibung hinzu',
      },
      minRows: 1,
      fields: [
        {
          ...
          label: 'Icon',
          admin: {
            description: 'Quadratisches Icon für das Feature. Empfohlen: 64x64px oder größer',
          },
          required: true,
        },
        {
